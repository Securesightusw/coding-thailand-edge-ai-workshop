...
**ตัวที่ค่าแยกสถานการณ์ได้ชัดสุด (น่าเอาไปเทรนบ่าย):** distance
## Challenge (ถ้าทำ)

- [ /] A — Proximity Alarm (sensor → buzzer)
- [ /] B — เก็บ Movement เป็น CSV ไว้เทรนบ่าย (ไฟล์อยู่ที่: skecth.ino)

**ติดอะไรตอนต่อ + แก้ยังไง (ถ้ามี):** เรียนและเก็บข้อมูลเพื่อทำต่อในตอนบ่าย
